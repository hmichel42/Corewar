...
- Le Corewar est un jeu très particulier. Il consiste à rassembler des joueurs autour d'une machine virtuelle, lesquels vont y charger des "champions". Les champions se battent à l'aide de "processus" dans le but, entre autres de se maintenir en vie.

- Les processus s'exécutent séquentiellement au sein de la même machine virtuelle et du même espace mémoire. Ils peuvent donc s'écrire les uns sur les autres afin de se corromprendre mutuellemnt, de forcer les autres à exécuter des instructions qui leur font du mal, etc ...

- Le jeu se termine quand plus aucun processus n'est en vie. Le dernier joueur à avoir été rapporté comme étant "en vie" gagne la partie.
...
Ce projet fait partie de la branche algorithmie de l'école 42 Lyon. Il fut réalisé par <a href="https://github.com/cgarrot">Cgarrot (@cgarrot)</a>, <a href="https://github.com/maegaspa">Maegaspa (@maegaspa)</a>, <a href="https://github.com/seanseau42">Seanseau (@seanseau42)</a> et <a href="https://github.com/hmichel42">Hmichel (@hmichel42)</a>.
